//! Windissect-generated Rust FFI bindings for StateRepository.Core.dll. Windows only.
#![allow(non_snake_case, non_camel_case_types, dead_code)]

pub mod handles;
pub mod vtables;

pub const EXPECTED_PDB_GUID: &str = "154386A8B04540E5567BB9195A914A9F";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 457270010;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 25] = [83, 116, 97, 116, 101, 82, 101, 112, 111, 115, 105, 116, 111, 114, 121, 46, 67, 111, 114, 101, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 457270010 { return 0; }
